...
knitr::opts_knit$set(root.dir = "~/Documents/LDS/Thesis/thesis")
library("papaja")
library(devtools)
library(childesr)
library(tidyverse)
...
write.csv(child_exclusions, "processed_data/child_exclusions.csv", row.names = FALSE)
write.csv(parent_exclusions, "processed_data/parent_exclusions.csv", row.names = FALSE)

child_exclusions <- read.csv("processed_data/child_exclusions.csv", stringsAsFactors=FALSE)
parent_exclusions <- read.csv("processed_data/parent_exclusions.csv", stringsAsFactors=FALSE)
```
